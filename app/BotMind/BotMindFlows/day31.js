...
["addition"+shuffledNumbersto[0]]: {
  ...
  additioncorrectq16: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>77</strong> 😎',
    answers: [
      {
  ...
  additioncorrectq17: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>101</strong> 😎',
  answers: [
    {
  ...
  additioncorrectq19: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>37</strong> Answers! 😎',
  answers: [
    {
  ...
  additioncorrectq20: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>96</strong> 😎',
  answers: [
    {
  ...
  input: selectField(['777', '767', "797","787"]),
  answers: [
    {
      answer: '777',
  ...
  additioncorrectq36: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>787</strong> 😎',
    answers: [
      {
  ...
  additioncorrectq37: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>821</strong> 😎',
  answers: [
    {
  ...
  additioncorrectq38: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>436</strong> 😎',
  answers: [
    {
  ...
  type: RTypes.TRANSFORMED_TEXT,
  input: selectField(['902', '912', "922","932"]),
  answers: [
    {
      answer: '902',
      nextId: 'inadditioncorrectq310',
    },
    {
      answer: '912',
  ...
  additioncorrectq39: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>912</strong> Answers! 😎',
  answers: [
    {
  ...
  type: RTypes.TRANSFORMED_TEXT,
  input: selectField(['103', '102', "104","105"]),
    answers: [
      {
        answer: '103',
  ...
  additioncorrectq40: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>103</strong> 😎',
  answers: [
    {
  ...
  ['addition'+shuffledNumbersto[55]]: {
    ...
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(['641', '651', "635","665"]),
    answers: [
      {
        answer: '641',
  ...
  additioncorrectq56: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>641</strong> 😎',
    answers: [
      {
  ...
  additioncorrectq57: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>443</strong> 😎',
  answers: [
    {
  ...
  type: RTypes.TRANSFORMED_TEXT,
  input: selectField(['108', '109', "110","111"]),
  answers: [
    {
      answer: '108',
  ...
  additioncorrectq58: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>108</strong> 😎',
  answers: [
    {
  ...
  additioncorrectq59: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>440</strong> Answers! 😎',
  answers: [
    {
  ...
  ['addition'+shuffledNumbersto[61]]: {
    ...
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(['621', '611', "610","620"]),
    answers: [
      {
        answer: '621',
  ...
  input: selectField(['489', '490', "478","500"]),
    answers: [
      {
        answer: '489',
  ...
  input: selectField(['1450', '1371', "1561","1471"]),
    answers: [
      {
        answer: '1450',
  ...
  additioncorrectq65: {
  botPrompt: 'Hurray! <strong>1471</strong> is the correct answer  ! 😎',
  answers: [
    {
  ...
  botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"1471"</strong>',
  answers: [
    {
      nextId: 'addition'+shuffledNumbersto[65],
    },
  ...
  input: selectField(['558', '570', "580","581"]),
  answers: [
    {
      answer: '558',
  ...
  input: selectField(['2296', '2364', "2690","2884"]),
    answers: [
      {
        answer: '2296',
  ...
  additioncorrectq68: {
  botPrompt: 'Hurray! <strong>2296</strong> is the correct answer  ! 😎',
  answers: [
    {
  ...
  botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"2296"</strong>',
  answers: [
    {
      nextId: 'addition'+shuffledNumbersto[68],
    },
  ...
  type: RTypes.TRANSFORMED_TEXT,
  input: selectField(['496', '486', "486","496"]),
  answers: [
    {
      answer: '496',
  ...
  type: RTypes.TRANSFORMED_TEXT,
  input: selectField(['138', '145', "137","138"]),
    answers: [
      {
        answer: '138',
  ...
  input: selectField(['1617', '1728', "1048","1748"]),
    answers: [
      {
        answer: '1617',
  ...
  additioncorrectq73: {
  botPrompt: 'Hurray! <strong>1728</strong> is the correct answer  ! 😎',
  answers: [
    {
  ...
  botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"1728"</strong>',
  answers: [
    {
      nextId: 'addition'+shuffledNumbersto[73],
    },
  ...
  ['addition'+shuffledNumbersto[75]]: {
    ...
    input: selectField(['169', '179', "189","209"]),
    answers: [
      {
        answer: '169',
  ...
  additioncorrectq76: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>169</strong> 😎',
    answers: [
      {
  ...
  additioncorrectq77: {
  botPrompt: 'You Have Selected correct Anwser 🎉! <strong>797</strong> 😎',
  answers: [
    {
  ...
  ['addition'+shuffledNumbersto[77]]: {
    ...
    input: selectField(['1196', '1169', "1197","1246"]),
      answers: [
        {
          answer: '1196',
    ...
    additioncorrectq79: {
    botPrompt: 'Hurray! <strong>1169</strong> is the correct answer  ! 😎',
    answers: [
      {
    ...
    botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"1169"</strong>',
    answers: [
      {
        nextId: 'addition'+shuffledNumbersto[79],
      },
    ...
    input: selectField(['1223', '1332', "1443","1542"]),
      answers: [
        {
          answer: '1223',
          nextId: 'inadditioncorrectq51',
    ...
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(['646', '686', "696","727"]),
      answers: [
        {
          answer: '646',
    ...
    input: selectField(['136', '147', "157","167"]),
      answers: [
        {
          answer: '136',
    ...
    additioncorrectq88: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>79</strong> 😎',
    answers: [
      {
    ...
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(['423', '444', "424","4445"]),
      answers: [
        {
          answer: '423',
          nextId: 'inadditioncorrectq87',
    ...
    additioncorrectq89: {
    botPrompt: 'You Have Selected correct Anwser 🎉! <strong>444</strong> Answers! 😎',
    answers: [
      {
    ...
    ["addition"+shuffledNumbersto[90]]: {
      ...
      type: RTypes.TRANSFORMED_TEXT,
      input: selectField(['95', '103', "105","128"]),
      answers: [
        {
          answer: '95',
    ...
    input: selectField(['1065', '1034', "1044","1054"]),
      answers: [
        {
          answer: '1065',
    ...
    additioncorrectq98: {
    botPrompt: 'Hurray! <strong>1044</strong> is the correct answer  ! 😎',
    answers: [
      {
    ...
    botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"1044"</strong>',
    answers: [
      {
        nextId: 'addition'+shuffledNumbersto[98],
      },
    ...
    ['addition'+shuffledNumbersto[98]]: {
      ...
      botPrompt: 'A train travels 786 kilometers on Monday, 658 kilometers on Tuesday, and 875 kilometers on Wednesday. What is the total distance traveled by the train on these three days?',
      type: RTypes.TRANSFORMED_TEXT,
  
  
      input: selectField(['2019', '2321', "2319","1997"]),
        answers: [
          {
            answer: '2019',
      ...
      additioncorrectq102: {
      botPrompt: 'Hurray! <strong>2019</strong> is the correct answer  ! 😎',
      answers: [
        {
      ...
      botPrompt: 'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"2019"</strong>',
      answers: [
        {
          nextId: 'addition'+shuffledNumbersto[102],
        },
