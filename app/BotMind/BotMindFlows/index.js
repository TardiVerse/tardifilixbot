...
function shuffleArrayto(array) {
  ...
  for (let i = shuffledArrayto.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffledArrayto[i], shuffledArrayto[j]] = [
      shuffledArrayto[j],
      shuffledArrayto[i],
    ];
  }
...
function shuffleArraythree(array) {
  ...
  for (let i = shuffledArraythree.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffledArraythree[i], shuffledArraythree[j]] = [
      shuffledArraythree[j],
      shuffledArraythree[i],
    ];
  }
...
function shuffleArraytwofive(array) {
  ...
  for (let i = shuffledArraytwofive.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffledArraytwofive[i], shuffledArraytwofive[j]] = [
      shuffledArraytwofive[j],
      shuffledArraytwofive[i],
    ];
  }
...
function shuffleArrayseventyseven(array) {
  ...
  for (let i = shuffledArrayseventyseven.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffledArrayseventyseven[i], shuffledArrayseventyseven[j]] = [
      shuffledArrayseventyseven[j],
      shuffledArrayseventyseven[i],
    ];
  }
...
// Shuffle the array
const shuffledNumbersseventyseven =
  shuffleArrayseventyseven(numbersseventyseven);
...
function shuffleArrayfifteen(array) {
  ...
  for (let i = shuffledArrayfifteen.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffledArrayfifteen[i], shuffledArrayfifteen[j]] = [
      shuffledArrayfifteen[j],
      shuffledArrayfifteen[i],
    ];
  }
...
function shuffleArrayten(array) {
  ...
  for (let i = shuffleArrayten.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffleArrayten[i], shuffleArrayten[j]] = [
      shuffleArrayten[j],
      shuffleArrayten[i],
    ];
  }
...
function shuffleArraynseve(array) {
  ...
  for (let i = shuffleArraynseve.length - 1; i > 0; i--) {
    const j = Math.floor(Math.random() * (i + 1));
    [shuffleArraynseve[i], shuffleArraynseve[j]] = [
      shuffleArraynseve[j],
      shuffleArraynseve[i],
    ];
  }
...
const questions = {
  start: {
    botPrompt:
      "Hello, I am <strong>FiliBot</strong> From the planet of joyful learning! Here to help you to eradicate learning lapses from every corners!",
    answers: [
      {
        nextId: "myPurpose",
      },
  ...
  myPurpose: {
    botPrompt:
      "<strong>Education For All </strong> (EFA) team of Filix School of Education has asked me to help you!",
    answers: [
      {
        nextId: "imageshare",
      },
  ...
  greetings_notAName: {
    botPrompt:
      "Hello! <strong>I'm still learning how to talk to humans</strong>, which means my conversational range is not very wide yet... 😅",
    answers: [
      {
...
day85comment: {
  ...
  insmallcorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"a"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[1],
      },
  ...
  insmallcorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"f"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[2],
      },
  ...
  insmallcorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"o"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[3],
      },
  ...
  insmallcorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"p"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[4],
      },
  ...
  insmallcorrectq5: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"q"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[5],
      },
  ...
  insmallcorrectq6: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"u"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[6],
      },
  ...
  insmallcorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"b"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[7],
      },
  ...
  insmallcorrectq8: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"d"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[8],
      },
  ...
  insmallcorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"i"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[9],
      },
  ...
  ["small_letter" + shuffledNumbersto[9]]: {
    botPrompt:
      " Identify the alphabet formed with one standing and one curved lines",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  insmallcorrectq10: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"n"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[10],
      },
  ...
  insmallcorrectq12: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"v"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[12],
      },
  ...
  ["small_letter" + shuffledNumbersto[12]]: {
    botPrompt:
      "Identify the alphabet made with slanting and two sleeping lines.",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  insmallcorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"z"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[13],
      },
  ...
  insmallcorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[14],
      },
  ...
  ["small_letter" + shuffledNumbersto[14]]: {
    botPrompt:
      "Find the alphabet that has one straight line and one curved line",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  insmallcorrectq15: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"h"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[15],
      },
  ...
  insmallcorrectq16: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"j"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[16],
      },
  ...
  ["small_letter" + shuffledNumbersto[16]]: {
    botPrompt:
      "Which alphabet is formed with three standing and two curved lines.",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["o", "n", "m", "p"]),
    answers: [
      {
  ...
  insmallcorrectq17: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"m"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[17],
      },
  ...
  insmallcorrectq18: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"r"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[18],
      },
  ...
  smallcorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>x</strong> Answers! 😎",
    answers: [
      {
  ...
  insmallcorrectq19: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"x"</strong>',
    answers: [
      {
        nextId: "small_letter" + shuffledNumbersto[19],
      },
  ...
  insmallcorrectq20: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"l"</strong>',
    answers: [
      {
        nextId: "wishtocontinue8",
      },
  ...
  wishtocontinue8: {
    botPrompt:
      "Your todays module is completed Do you wish to continue for next DAY Task ? ",
    input: selectField(["Yes!", "No!"]),
    answers: [
      {
        answer: "Yes!",
  ...
  day9: {
    botPrompt:
      " <strong> Day 9 : </strong> Learn your vowels through a fun song and dance",
    answers: [{ nextId: "day9link" }],
  },
  ...
  day10comment: {
    ...
    answers: [{ nextId: "numbers" + shuffledNumbersnseve[0] }],
  },
  ...
  innumberscorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"5"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[1],
      },
  ...
  innumberscorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"6"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[3],
      },
  ...
  innumberscorrectq4: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"4"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[4],
      },
  ...
  innumberscorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"8"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[7],
      },
  ...
  innumberscorrectq8: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"9"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[8],
      },
  ...
  innumberscorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"10"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[9],
      },
  ...
  innumberscorrectq10: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"3"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[10],
      },
  ...
  innumberscorrectq11: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"2"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[11],
      },
  ...
  innumberscorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"7"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[13],
      },
  ...
  innumberscorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"16"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[14],
      },
  ...
  numberscorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>2</strong> Answers! 😎",
    answers: [
      {
  ...
  innumberscorrectq21: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"21"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[21],
      },
  ...
  innumberscorrectq25: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"12"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[25],
      },
  ...
  innumberscorrectq27: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"18"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[27],
      },
  ...
  innumberscorrectq28: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"19"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[28],
      },
  ...
  innumberscorrectq31: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"1"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[31],
      },
  ...
  innumberscorrectq33: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"26"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[33],
      },
  ...
  innumberscorrectq35: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"0"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[35],
      },
  ...
  innumberscorrectq36: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"15"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[36],
      },
  ...
  numberscorrectq39: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>9</strong> Answers! 😎",
    answers: [
      {
  ...
  innumberscorrectq41: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"22"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[41],
      },
  ...
  innumberscorrectq42: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"31"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[42],
      },
  ...
  innumberscorrectq43: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"11"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[43],
      },
  ...
  innumberscorrectq44: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"36"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[44],
      },
  ...
  innumberscorrectq45: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"49"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[45],
      },
  ...
  innumberscorrectq49: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"30"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[49],
      },
  ...
  innumberscorrectq50: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"61"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[50],
      },
  ...
  innumberscorrectq51: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"99"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[51],
      },
  ...
  innumberscorrectq53: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"32"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[53],
      },
  ...
  innumberscorrectq54: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"17"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[54],
      },
  ...
  innumberscorrectq55: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"44"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[55],
      },
  ...
  innumberscorrectq56: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"76"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[56],
      },
  ...
  innumberscorrectq57: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"89"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[57],
      },
  ...
  numberscorrectq59: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>6</strong> Answers! 😎",
    answers: [
      {
  ...
  ["numbers" + shuffledNumbersnseve[64]]: {
    botPrompt:
      "Which number is smaller, the sum of 6 and 4 or the product of 3 and 4?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  numberscorrectq65: {
    botPrompt:
      "Hurray! <strong>Sum of 6 and 4</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  innumberscorrectq65: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Sum of 6 and 4"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[65],
      },
  ...
  innumberscorrectq66: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"90"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[66],
      },
  ...
  ["numbers" + shuffledNumbersnseve[67]]: {
    botPrompt:
      "Which number is greater, the sum of 8 and 3 or the product of 2 and 7?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  numberscorrectq68: {
    botPrompt:
      "Hurray! <strong>Sum of 8 and 3</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  innumberscorrectq68: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Sum of 8 and 3"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[68],
      },
  ...
  innumberscorrectq73: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"29"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[73],
      },
  ...
  innumberscorrectq75: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"13"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[75],
      },
  ...
  innumberscorrectq88: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"20"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[88],
      },
  ...
  numberscorrectq89: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>16</strong> Answers! 😎",
    answers: [
      {
  ...
  innumberscorrectq20: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"24"</strong>',
    answers: [
      {
        nextId: "numbers" + shuffledNumbersnseve[90],
      },
  ...
  vowels_prompt4: {
    botPrompt:
      "https://drive.google.com/file/d/11fCjQs0U8ubxkZpqoHLDRtSszQQFv0d5/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  vowels_prompt5: {
    ...
    answers: [{ nextId: "vvowels_prompt6" }],
  },
  vowels_prompt6: {
  ...
  ["vowels_question" + shuffledNumbers[0]]: {
    botPrompt:
      ' Which letter(s) is a vowel in the word <strong>"cat" </strong>? ',
    type: RTypes.TRANSFORMED_TEXT,
  ...
  correctq3: {
    botPrompt:
      "Hurray! <strong>None of the Above</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"None of the Above"</strong>',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[3],
      },
  ...
  incorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"E"</strong>',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[7],
      },
  ...
  correctq19: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! <strong>O</strong>  or <strong>I</strong> are the Correct Answers! 😎",
    answers: [
      {
  ...
  incorrectq19: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"O" or "I"</strong>',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[19],
      },
  ...
  correctq20: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! B<strong>E</strong>tt<strong>E</strong>R 😎",
    answers: [
      {
  ...
  correctq23: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! STR<strong>I</strong>NG  or STR<strong>O</strong>NG 😎",
    answers: [
      {
  ...
  incorrectq23: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"I"or"O"</strong>',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[23],
      },
  ...
  correctq24: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! S<strong>U</strong>N  or S<strong>I</strong>N or S<strong>O</strong>N are the Correct Answers! 😎",
    answers: [
      {
  ...
  incorrectq25: {
    botPrompt:
      "You have selected wrong Answer... 🤔 the <strong>right</strong> answer is CL<strong>A</strong>SS",
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[25],
      },
  ...
  correctq26: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! GL<strong>A</strong>SS  😎",
    answers: [
      {
  ...
  correctq30: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! CL<strong>O</strong>CK  or CL<strong>I</strong>CK  😎",
    answers: [
      {
  ...
  incorrectq30: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"O"</strong> or <strong>"I"</strong> ',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[30],
      },
  ...
  correctq31: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! B<strong>A</strong>T or B<strong>O</strong>T😎",
    answers: [
      {
  ...
  incorrectq31: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"A or O"</strong>',
    answers: [
      {
        nextId: "vowels_question" + shuffledNumbers[31],
      },
  ...
  correctq34: {
    botPrompt:
      "You Have Selected Correct Anwser 🎉! H<strong>U</strong>NGRY 😎",
  ...
  day12: {
    botPrompt:
      "<strong> Day 12 : </strong> Let`s play and jump to understand Ascending and descending order.",
    answers: [{ nextId: "day12link" }],
  },
  ...
  day122comment: {
    ...
    answers: [{ nextId: "day123link" }],
  },
  day123link: {
    botPrompt:
      "https://drive.google.com/file/d/1XDt31gFusGyBB7m5ZDskmWXzZof76o23/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  day13: {
    botPrompt:
      "<strong> Day 13 : </strong>Letters of the alphabet that are not vowels are called consonants.",
    answers: [{ nextId: "day13link" }],
  },
  ...
  day132comment: {
    ...
    answers: [{ nextId: "day131link" }],
  },
  day131link: {
    botPrompt:
      "https://drive.google.com/file/d/1A7iYok28f96lk5gWf6rsv2iyZRM5VX7e/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inconsonantscorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"a,p,l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[1],
      },
  ...
  consonantscorrectq2: {
    botPrompt:
      "Hurray! <strong>l, p, h, n, t</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"l, p, h, n, t"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[2],
      },
  ...
  consonantscorrectq3: {
    botPrompt:
      "Hurray! <strong>Both A and B</strong> is the correct answer ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Both A and B"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[3],
      },
  ...
  consonantscorrectq4: {
    botPrompt:
      "Hurray! <strong>r, n, b, w</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq4: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"r, n, b, w"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[4],
      },
  ...
  inconsonantscorrectq5: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"f, r, g"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[5],
      },
  ...
  consonantscorrectq6: {
    botPrompt:
      "Hurray! <strong>p, n, c, l</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq6: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"p, n, c, l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[6],
      },
  ...
  inconsonantscorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"g, r, f"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[7],
      },
  ...
  consonantscorrectq8: {
    botPrompt:
      "Hurray! <strong>f, l, w, r</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq8: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"f, l, w, r"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[8],
      },
  ...
  consonantscorrectq9: {
    botPrompt:
      "Hurray! <strong>b, s, k, t</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"b, s, k, t"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[9],
      },
  ...
  inconsonantscorrectq10: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c, r, t"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[10],
      },
  ...
  inconsonantscorrectq11: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"s, m, l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[11],
      },
  ...
  inconsonantscorrectq12: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c, h, s"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[12],
      },
  ...
  consonantscorrectq13: {
    botPrompt:
      "Hurray! <strong>b, t, r, f, l,y</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"b, t, r, f, l,y"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[13],
      },
  ...
  consonantscorrectq14: {
    botPrompt:
      "Hurray! <strong>b, s, k, t, l</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"b, s, k, t, l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[14],
      },
  ...
  inconsonantscorrectq15: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"l, m, n"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[15],
      },
  ...
  consonantscorrectq16: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>l, p, h, n, t</strong> 😎",
    answers: [
      {
  ...
  consonantscorrectq17: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>m, n, t, n</strong> 😎",
    answers: [
      {
  ...
  inconsonantscorrectq17: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"m, n, t, n"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[17],
      },
  ...
  consonantscorrectq18: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>t, r, n, g, l</strong> 😎",
    answers: [
      {
  ...
  inconsonantscorrectq18: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"t, r, n, g, l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[18],
      },
  ...
  consonantscorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>c, m, p, t, r</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq19: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c, m, p, t, r"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[19],
      },
  ...
  consonantscorrectq20: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>g, t, r</strong> 😎",
    answers: [
      {
  ...
  inconsonantscorrectq20: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"g, t, r"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[20],
      },
  ...
  consonantscorrectq21: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>c, n, c,s</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq21: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c, n, c,s"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[21],
      },
  ...
  consonantscorrectq22: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>c,n,o</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq22: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"c,n,o"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[22],
      },
  ...
  consonantscorrectq23: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>s, n, t, c</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq23: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"s, n, t, c"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[23],
      },
  ...
  consonantscorrectq24: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>l, v, n</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq24: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"l, v, n"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[24],
      },
  ...
  consonantscorrectq25: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>b, r, t, h</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq25: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"b, r, t, h"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[25],
      },
  ...
  consonantscorrectq26: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>d, m, n, d</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq26: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"d, m, n, d"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersto[26],
      },
  ...
  consonantscorrectq27: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>j, n, g, l</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq27: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"j, n, g, l"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersto[27],
      },
  ...
  consonantscorrectq28: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>t, c, h, r</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq28: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"t, c, h, r"</strong>',
    answers: [
      {
        nextId: "consonants" + shuffledNumbersthree[28],
      },
  ...
  consonantscorrectq29: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>v, l, g</strong> Answers! 😎",
    answers: [
      {
  ...
  inconsonantscorrectq29: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"v, l, g"</strong>',
    answers: [
      {
        nextId: "wishtocontinue13",
      },
  ...
  day14: {
    botPrompt:
      "<strong> Day 14 : </strong>Articles add an identity to the noun.",
    answers: [{ nextId: "day142comment" }],
  },
  day142comment: {
    botPrompt: "Let`s understand with an activity",
    answers: [{ nextId: "day14link" }],
  },
  day14link: {
  ...
  day143comment: {
    botPrompt: "Let`s understand with an activity",
    answers: [{ nextId: "day141link" }],
  },

  day141link: {
    botPrompt:
      "https://drive.google.com/file/d/1slxqfoLFs9sv7ctQb54_-G8snOXLhiS_/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inarticlecorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"an"</strong>',
    answers: [
      {
        nextId: "article" + shuffledNumberstwofive[3],
      },
  ...
  day15: {
    botPrompt:
      "<strong> Day 15 : </strong>Let`s Learn One/Many through an activity",
    answers: [{ nextId: "day15link" }],
  },
  day15link: {
  ...
  inoneandmanycorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>one</strong> answer is <strong>"a"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[1],
      },
  ...
  inoneandmanycorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"many"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[2],
      },
  ...
  inoneandmanycorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"one"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[3],
      },
  ...
  inoneandmanycorrectq6: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"any"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[6],
      },
  ...
  inoneandmanycorrectq11: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"books"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[11],
      },
  ...
  inoneandmanycorrectq12: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"dogs"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[12],
      },
  ...
  inoneandmanycorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"leaves"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[13],
      },
  ...
  oneandmanycorrectq14: {
    botPrompt:
      "Hurray! <strong>butterflies</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"butterflies"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[14],
      },
  ...
  inoneandmanycorrectq15: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"apples"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[15],
      },
  ...
  oneandmanycorrectq16: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>children</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq16: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"children"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[16],
      },
  ...
  inoneandmanycorrectq17: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"keys"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[17],
      },
  ...
  inoneandmanycorrectq18: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"toys"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[18],
      },
  ...
  oneandmanycorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>mice</strong> Answers! 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq19: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"mice"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[19],
      },
  ...
  inoneandmanycorrectq20: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Bags"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[20],
      },
  ...
  oneandmanycorrectq23: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>butterflies</strong> 😎",
    answers: [
      {
  ...
  oneandmanycorrectq25: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>balloons</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq25: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"balloons"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[25],
      },
  ...
  oneandmanycorrectq26: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>brothers</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq26: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"brothers"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[26],
      },
  ...
  oneandmanycorrectq27: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>fishes</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq27: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"fishes"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[27],
      },
  ...
  oneandmanycorrectq28: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>pencils</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq28: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"pencils"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[28],
      },
  ...
  oneandmanycorrectq29: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>horses</strong> 😎",
    answers: [
      {
  ...
  inoneandmanycorrectq29: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"horses"</strong>',
    answers: [
      {
        nextId: "oneandmany" + shuffledNumbersthree[29],
      },
  ...
  inoneandmanycorrectq30: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"teeth"</strong>',
    answers: [
      {
        nextId: "day152comment",
      },
  ...
  day152comment: {
    ...
    answers: [{ nextId: "day152link" }],
  },

  day152link: {
    botPrompt:
      "https://drive.google.com/file/d/1wtvzS0JEKi2xaeJMAIhHGV9H5DOlt36U/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  day131link: {
    botPrompt:
      "https://drive.google.com/file/d/1IGgEghI26qgqAIND8UNS-Pu-pTiS6AQv/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inisArecorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"is"</strong>',
    answers: [
      {
        nextId: "isAre" + shuffledNumbersseventyseven[1],
      },
  ...
  inisArecorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"are"</strong>',
    answers: [
      {
        nextId: "isAre" + shuffledNumbersseventyseven[2],
      },
  ...
  isArecorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>are</strong> Answers! 😎",
    answers: [
      {
  ...
  isArecorrectq59: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>is</strong> Answers! 😎",
    answers: [
      {
  ...
  day17: {
    botPrompt:
      "<strong> Day 17 : </strong> How do we know who comes before, after and between? ",
    answers: [{ nextId: "day17link" }],
  },
  ...
  day172comment: {
    botPrompt: "Let’s look into the pages of the book",
    answers: [{ nextId: "day171link" }],
  },
  day171link: {
    botPrompt:
      "https://drive.google.com/file/d/19oC4e3PGh4eVjzv1skiW4eYwGs07u2W8/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  day18: {
    botPrompt:
      "<strong> Day 18 : </strong> This and That is used to point to things or objects. `This` is used to point to things which are near and `That` is used to point things which are far. ",
    answers: [{ nextId: "day18link" }],
  },
  ...
  day182comment: {
    botPrompt: "Let`s look into the pages of the book",
    answers: [{ nextId: "day181link" }],
  },
  day181link: {
    botPrompt:
      "https://drive.google.com/file/d/1jZEUmqQn5AtQFDEdz5rVUDPDGC9Ujzcj/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inthisThatcorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"This"</strong>',
    answers: [
      {
        nextId: "thisThat" + shuffledNumbersfifteen[1],
      },
  ...
  inthisThatcorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"That"</strong>',
    answers: [
      {
        nextId: "thisThat" + shuffledNumbersfifteen[2],
      },
  ...
  ["thisThat" + shuffledNumbersfifteen[4]]: {
    botPrompt:
      "5. Which word would you use to describe an object you are holding?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[5]]: {
    botPrompt:
      " 6. Which word would you use to describe objects that are far away from you?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[6]]: {
    botPrompt:
      "7. Which word would you use to talk about something you can see but can`t touch?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[7]]: {
    botPrompt:
      "8. Which word would you use to ask about a specific object that is not close to you?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[8]]: {
    botPrompt:
      "9. Which word would you use to point to something close to you?",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["This", "That", "These"]),
    answers: [
      {
  ...
  ["thisThat" + shuffledNumbersfifteen[9]]: {
    botPrompt:
      "10. Which word would you use to point to something far from you?",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["This", "That", "These"]),
    answers: [
      {
  ...
  ["thisThat" + shuffledNumbersfifteen[10]]: {
    botPrompt:
      "11. Which word would you use to describe an object near your friend?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[11]]: {
    botPrompt:
      "12. Which word would you use to talk about something you can touch right now?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[12]]: {
    botPrompt:
      "13. Which word would you use to talk about something you can see across the room?",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["This", "That", "These"]),
    answers: [
      {
  ...
  ["thisThat" + shuffledNumbersfifteen[13]]: {
    botPrompt:
      "14. Which word would you use to talk about objects that are far away from both you and your friend?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["thisThat" + shuffledNumbersfifteen[14]]: {
    botPrompt:
      "15. Which word would you use to ask about a specific object that is not close to you or your friend?",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["This", "That", "These"]),
    answers: [
      {
  ...
  day19: {
    botPrompt:
      "<strong> Day 19 : </strong> Zero is a number with no value. It means none or nothing or empty. ",
    answers: [{ nextId: "day19link" }],
  },
  ...
  zerocorrect: {
    botPrompt:
      "Hurray <strong>nothing or empty</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inzerocorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"nothing or empty"</strong>',
    answers: [
      {
        nextId: "zero" + shuffledNumbersten[1],
      },
  ...
  zerocorrectq2: {
    botPrompt:
      "Hurray! <strong>The number stays the same</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inzerocorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"The number stays the same"</strong>',
    answers: [
      {
        nextId: "zero" + shuffledNumbersten[2],
      },
  ...
  ["zero" + shuffledNumbersten[4]]: {
    ...
    input: selectField([
      "You have a lot of chocolates",
      "You have no chocolates",
      "You have one chocolate",
      "You have two chocolates",
    ]),
    answers: [
      {
  ...
  zerocorrectq5: {
    botPrompt:
      "Hurray! <strong>You have no chocolates</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inzerocorrectq5: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"You have no chocolates"</strong>',
    answers: [
      {
        nextId: "zero" + shuffledNumbersten[5],
      },
  ...
  ["zero" + shuffledNumbersten[5]]: {
    botPrompt:
      "If you have five marbles and you give away zero marbles,how many marbles do you have left?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  inzerocorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"10-10    "</strong>',
    answers: [
      {
        nextId: "zero" + shuffledNumbersten[7],
      },
  ...
  ["zero" + shuffledNumbersten[7]]: {
    botPrompt:
      "If you have zero pencils and someone gives you five pencils how many pencils do you have now?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  zerocorrectq9: {
    botPrompt:
      "Hurray! <strong>any number</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  inzerocorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"any number"</strong>',
    answers: [
      {
        nextId: "wishtocontinue19",
      },
  ...
  day20: {
    ...
    answers: [{ nextId: "day20comment" }],
  },

  day20comment: {
    botPrompt: "Pages of the book",
    answers: [{ nextId: "isAre" + shuffledNumbersseventyseven[0] }],
  },
  ...
  day21: {
    ...
    answers: [{ nextId: "day21newcomment" }],
  },
  day21newcomment: {
    botPrompt:
      "These and Those point towards more than one object which is near or far from us.",
    answers: [{ nextId: "day21newlink" }],
  },
  day21newlink: {
  ...
  day212newcomment: {
    botPrompt: "Let`s look into the pages of the book",
    answers: [{ nextId: "day212newlink" }],
  },

  day212newlink: {
    botPrompt:
      "https://drive.google.com/file/d/13Ke6FuVWHHPAHoEhh3zob9onVHfTcFe8/view?usp=sharing",
    type: RTypes.MEDIA,
    answers: [
      {
  ...
  day213newcomment: {
    botPrompt: "Let`s solve",
    answers: [{ nextId: "theseThose" + shuffleArrayten[0] }],
  },
  ...
  ["theseThose" + shuffleArrayten[0]]: {
    botPrompt:
      "Which word would you use to talk about objects that are not near you? ",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  intheseThosecorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Those"</strong>',
    answers: [
      {
        nextId: "theseThose" + shuffleArrayten[1],
      },
  ...
  ["theseThose" + shuffleArrayten[1]]: {
    botPrompt:
      "What word would you use to talk about objects that are specific and close to us?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  intheseThosecorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"These"</strong>',
    answers: [
      {
        nextId: "theseThose" + shuffleArrayten[2],
      },
  ...
  ["theseThose" + shuffleArrayten[2]]: {
    botPrompt:
      "What word would you use to talk about objects that are far from us and not specific?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["theseThose" + shuffleArrayten[4]]: {
    botPrompt:
      "What word would you use to talk about objects that are in the distance? ",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["theseThose" + shuffleArrayten[5]]: {
    botPrompt:
      "Look around the classroom. Which word would you use to talk about objects that are far from you?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  ["theseThose" + shuffleArrayten[6]]: {
    botPrompt:
      " Which word would you use to talk about objects that are not nearby?",
    type: RTypes.TRANSFORMED_TEXT,
    input: selectField(["Those", "These", "This", "There"]),
    answers: [
      {
  ...
  ["theseThose" + shuffleArrayten[7]]: {
    botPrompt:
      "Look around the classroom. Which word would you use to talk about objects that are near you?",
    type: RTypes.TRANSFORMED_TEXT,
  ...
  day22: {
    ...
    answers: [{ nextId: "day22newcomment" }],
  },
  day22newcomment: {
    botPrompt:
      "Simon says It is a joyful game which can be played to grab the attention of the children , make children follow instructions and learn action words simultaneously.",
    answers: [{ nextId: "daynew221" }],
  },
  ...
  day23: {
    ...
    answers: [{ nextId: "day23newcomment" }],
  },
  day23newcomment: {
    botPrompt:
      'Good manners begin with the magic words "please", "thank you", "welcome",”Excuse me and "I`m sorry".',
    answers: [{ nextId: "day231newcomment" }],
  },
  day231newcomment: {
    botPrompt:
      "Let`s build a simple Teaching Learning Material to remind students of the Five Magic words.",
    answers: [{ nextId: "day232newcomment" }],
  },
  day232newcomment: {
  ...
  day24: {
    ...
    answers: [{ nextId: "day24newcomment" }],
  },
  day24newcomment: {
    botPrompt:
      "One more and one less teaches a child first steps of addition and substaction.",
    answers: [{ nextId: "day241newcomment" }],
  },
  day241newcomment: {
    botPrompt: "One More Than/One Less Than",
    answers: [{ nextId: "day242newcomment" }],
  },
  day242newcomment: {
  ...
  day243newcomment: {
    botPrompt: "One More Than/One Less Than",
    answers: [{ nextId: "day244newcomment" }],
  },
  day244newcomment: {
    botPrompt:
      "https://drive.google.com/file/d/1j1Y5l93tdhedlVv13mbEp5F-63kptgLR/view?usp=share_link",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inmoreLesscorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"14"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[3],
      },
  ...
  moreLesscorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>11</strong> Answers! 😎",
    answers: [
      {
  ...
  inmoreLesscorrectq21: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"23"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[21],
      },
  ...
  inmoreLesscorrectq25: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"27"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[25],
      },
  ...
  inmoreLesscorrectq28: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"35"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[28],
      },
  ...
  inmoreLesscorrectq29: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"34"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[29],
      },
  ...
  inmoreLesscorrectq30: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"33"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[30],
      },
  ...
  inmoreLesscorrectq32: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"37"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[32],
      },
  ...
  inmoreLesscorrectq33: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"50"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[33],
      },
  ...
  inmoreLesscorrectq34: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"48"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[34],
      },
  ...
  inmoreLesscorrectq35: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"41"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[35],
      },
  ...
  inmoreLesscorrectq37: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"47"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[37],
      },
  ...
  moreLesscorrectq39: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>42</strong> Answers! 😎",
    answers: [
      {
  ...
  inmoreLesscorrectq39: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"42"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[39],
      },
  ...
  inmoreLesscorrectq40: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"39"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[40],
      },
  ...
  inmoreLesscorrectq41: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"45"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[41],
      },
  ...
  inmoreLesscorrectq42: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"46"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[42],
      },
  ...
  inmoreLesscorrectq43: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"38"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[43],
      },
  ...
  inmoreLesscorrectq44: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"25"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[44],
      },
  ...
  inmoreLesscorrectq45: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"28"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[45],
      },
  ...
  inmoreLesscorrectq48: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"40"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[48],
      },
  ...
  inmoreLesscorrectq49: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"43"</strong>',
    answers: [
      {
        nextId: "moreLess" + shuffleArraynseve[49],
      },
  ...
  moreLesscorrectq89: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>39</strong> Answers! 😎",
    answers: [
      {
  ...
  day25: {
    botPrompt:
      "<strong> Day 25 : </strong> Capital letters, full stops, and question marks play a crucial role in kindergarten education by helping young learners understand sentence structure and punctuation rules.",
    answers: [{ nextId: "day25link" }],
  },
  ...
  day252comment: {
    botPrompt: "Let’s look into the pages of the book",
    answers: [{ nextId: "day252link" }],
  },
  day252link: {
    botPrompt:
      "https://drive.google.com/file/d/1vZFs9aRgL-fmnPrG_XfmNk9Z1xUg-Goz/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
        nextId: "day253link",
  ...
  day253link: {
    botPrompt:
      "https://drive.google.com/file/d/1iXpfIffsy556QVrDvtDN1Gg8wC3Iy9oX/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  capitalLetterFullStopcorrect: {
    botPrompt:
      "Hurray <strong>I have a red bicycle.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"I have a red bicycle."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[1],
      },
  ...
  capitalLetterFullStopcorrectq2: {
    botPrompt:
      "Hurray! <strong>They went to the zoo.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"They went to the zoo."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[2],
      },
  ...
  capitalLetterFullStopcorrectq3: {
    botPrompt:
      "Hurray! <strong>My sister likes to read Books.</strong> is the correct answer ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"My sister likes to read Books."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[3],
      },
  ...
  capitalLetterFullStopcorrectq4: {
    botPrompt:
      "Hurray! <strong>We live in a small town.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq4: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"We live in a small town."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[4],
      },
  ...
  capitalLetterFullStopcorrectq5: {
    botPrompt:
      "Hurray! <strong>She has two cats and a dog.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq5: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"She has two cats and a dog."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[5],
      },
  ...
  capitalLetterFullStopcorrectq6: {
    botPrompt:
      "Hurray! <strong>I want to go to the beach.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq6: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"I want to go to the beach."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[6],
      },
  ...
  capitalLetterFullStopcorrectq7: {
    botPrompt:
      "Hurray! <strong>They have a picnic in the park.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"They have a picnic in the park."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[7],
      },
  ...
  capitalLetterFullStopcorrectq8: {
    botPrompt:
      "Hurray! <strong>I eat an apple every day.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq8: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"I eat an apple every day."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[8],
      },
  ...
  capitalLetterFullStopcorrectq9: {
    botPrompt:
      "Hurray! <strong>We go swimming in the pool.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"We go swimming in the pool."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[9],
      },
  ...
  capitalLetterFullStopcorrectq10: {
    botPrompt:
      "Hurray! <strong>She has a big smile on her face.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq10: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"She has a big smile on her face."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[10],
      },
  ...
  capitalLetterFullStopcorrectq11: {
    botPrompt:
      "Hurray! <strong>I see a bird in the tree.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq11: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"I see a bird in the tree."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[11],
      },
  ...
  capitalLetterFullStopcorrectq12: {
    botPrompt:
      "Hurray! <strong>They enjoy playing games.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq12: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"They enjoy playing games."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[12],
      },
  ...
  capitalLetterFullStopcorrectq13: {
    botPrompt:
      "Hurray! <strong>My mom makes tasty food.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"My mom makes tasty food."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[13],
      },
  ...
  capitalLetterFullStopcorrectq14: {
    botPrompt:
      "Hurray! <strong>The cat is sleeping on the mat.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"The cat is sleeping on the mat."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[14],
      },
  ...
  capitalLetterFullStopcorrectq15: {
    botPrompt:
      "Hurray! <strong>This is a bird.</strong> is the correct answer  ! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq15: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"This is a bird."</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[15],
      },
  ...
  capitalLetterFullStopcorrectq16: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>Incorrect</strong> 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq16: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Incorrect"</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[16],
      },
  ...
  capitalLetterFullStopcorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>Incorrect</strong> Answers! 😎",
    answers: [
      {
  ...
  incapitalLetterFullStopcorrectq26: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Correct"</strong>',
    answers: [
      {
        nextId: "capitalLetterFullStop" + shuffledNumbers[26],
      },
  ...
  day26: {
    botPrompt:
      "<strong> Day 26 : </strong> Learning opposites help in adding to a childs vocabulary and understanding how the world around functions.",
    answers: [{ nextId: "day26link" }],
  },

  day26link: {
    botPrompt:
      "https://www.youtube.com/watch?v=wpSUK7FnSVA&list=PLhVY3NLECmvXWnTL_xjBImY2ZbKD2XOyp&index=6&pp=iAQB",
    type: RTypes.LINK,
    answers: [
      {
  ...
  day263comment: {
    botPrompt: "Let’s look into the pages of the book",
    answers: [{ nextId: "day263link" }],
  },
  day263link: {
    botPrompt:
      "https://drive.google.com/file/d/1MdSOrmqghLRHbhcES9M1liAEfaPC2Yqz/view?usp=sharing",
    type: RTypes.LINK,
    answers: [
      {
  ...
  inoppositescorrect: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Small"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[1],
      },
  ...
  inoppositescorrectq2: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"sad"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[2],
      },
  ...
  inoppositescorrectq3: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"cold"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[3],
      },
  ...
  inoppositescorrectq4: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Down"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[4],
      },
  ...
  inoppositescorrectq5: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Night"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[5],
      },
  ...
  inoppositescorrectq6: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"fast"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[6],
      },
  ...
  inoppositescorrectq7: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"far"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[7],
      },
  ...
  inoppositescorrectq8: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Open"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[8],
      },
  ...
  inoppositescorrectq9: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Full"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[9],
      },
  ...
  inoppositescorrectq10: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Dirty"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[10],
      },
  ...
  inoppositescorrectq11: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Quiet"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[11],
      },
  ...
  inoppositescorrectq12: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Dry"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[12],
      },
  ...
  inoppositescorrectq13: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Slow"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[13],
      },
  ...
  inoppositescorrectq14: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Dark"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[14],
      },
  ...
  inoppositescorrectq15: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Out"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[15],
      },
  ...
  inoppositescorrectq16: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Old"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[16],
      },
  ...
  inoppositescorrectq18: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Loud"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[18],
      },
  ...
  oppositescorrectq19: {
    botPrompt:
      "You Have Selected correct Anwser 🎉! <strong>Thin</strong> Answers! 😎",
    answers: [
      {
  ...
  inoppositescorrectq19: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Thin"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[19],
      },
  ...
  inoppositescorrectq20: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Short"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[20],
      },
  ...
  inoppositescorrectq21: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Soft"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[21],
      },
  ...
  inoppositescorrectq22: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"young"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[22],
      },
  ...
  inoppositescorrectq23: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"girl"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[23],
      },
  ...
  inoppositescorrectq24: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"Asleep"</strong>',
    answers: [
      {
        nextId: "opposites" + shuffleArraytwofive[24],
      },
  ...
  inoppositescorrectq25: {
    botPrompt:
      'You have selected wrong Answer... 🤔 the <strong>right</strong> answer is <strong>"sweet"</strong>',
    answers: [
      {
        nextId: "wishtocontinue26",
      },
  ...
  select: {
    botPrompt:
      "I can also offer <strong>predefined options</strong> to choose from:",
    varName: "userName",
  ...
  tags: {
    botPrompt:
      "Or even <strong>allow users to select many tags</strong> to form an answer:",
    varName: "userName",
    input: tagsField(["Do go on..", "Amazing!", "I'm loving this!", "🍕"]),
    answers: [{ nextId: "bagsSystem" }],
  },
  bagsSystem: {
    botPrompt:
      "Besides all that, I can add up points in my <strong>Bags System</strong>, to eventually make a 'Recommendation'",
    answers: [{ nextId: "letsTryIt" }],
  },
  letsTryIt: {
    botPrompt: "Let's try it!",
    answers: [{ nextId: "question1" }],
  },
    ...
    answers: [
      {
        ...
        nextId: "cool",
        sumToBags: [
          { name: "rickAndMorty", points: 3 },
          { name: "shroedingersCat", points: 2 },
          { name: "recursion", points: 1 },
        ],
      },
      {
        answer: "No.",
        nextId: "hmkay",
        sumToBags: [
          { name: "shroedingersCat", points: 1 },
          { name: "recursion", points: 3 },
        ],
      },
      {
        answer: "I'm not Sure",
  ...
  question2: {
    botPrompt:
      "Do you know what the <strong>airspeed velocity of an <em>unladen swallow</em></strong> is? 🐦",
    input: selectField([
      "African or European?",
      "10 m/s",
  ...
  gottaGive: {
    botPrompt:
      "For demonstrative purposes I gotta give you some kind of recommendation, so...",
    answers: [
      {
  ...
  rickAndMorty2: {
    botPrompt:
      "My best recommendation is you should go and watch something <a href='www.adultswim.com/videos/rick-and-morty/'>fun</a>!",
    answers: [
      {
  ...
  shroedingersCat: {
    botPrompt:
      "Don't you just feel like <a href='https://en.wikipedia.org/wiki/Schr%C3%B6dinger%27s_cat'>Shroedinger's Cat</a> sometimes <strong>@varName</strong>?",
    type: RTypes.TRANSFORMED_TEXT,
    varName: "userName",
    answers: [
      {
  ...
  shroedingersCat3: {
    botPrompt:
      "It looks like you're in a sort of <strong>quantum-superposition state</strong>. You should really go out and figure out where (and when) you are at in your life... Cheers!",
    answers: [
      {
        nextId: "check_out1",
        finishConversation: true,
  ...
  check_out1: {
    botPrompt:
      "Check out how to build your own, fully customizable, web-based bot in here",
    answers: [
      {
        nextId: "check_out2",
      },
